...
mixin _$Group {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, teacherId, createdAt);

  @override
  String toString() {
    return 'Group(id: $id, name: $name, teacherId: $teacherId, createdAt: $createdAt)';
  }
}
...
abstract mixin class $GroupCopyWith<$Res> {
  factory $GroupCopyWith(Group value, $Res Function(Group) _then) =
      _$GroupCopyWithImpl;
  @useResult
  $Res call({int id, String name, int? teacherId, DateTime? createdAt});
}
...
extension GroupPatterns on Group {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String name, int? teacherId, DateTime? createdAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Group() when $default != null:
        return $default(_that.id, _that.name, _that.teacherId, _that.createdAt);
      case _:
        return orElse();
    }
  }
...
class _Group implements Group {
  const _Group(
      {this.id = 0, required this.name, this.teacherId, this.createdAt});
